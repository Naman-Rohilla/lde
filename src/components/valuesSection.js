    ...
    <section class="pt-20 lg:pt-[120px] pb-8 lg:pb-[70px]">
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full">
            <div class="mb-12 lg:mb-20 max-w-[620px] text-center md:text-start">
              ...
              >
                ...
                We work closely with each client to tailor packaging solutions
                that meet their specific needs, ensuring the highest standards
        ...
        <div class="flex md:flex-wrap overflow-scroll element space-x-2 md:space-x-0">
          <div class="w-full shrink-0 md:px-4  md:w-1/2 lg:w-1/4">
            <div class="bg-white mb-12 group wow fadeInUp" data-wow-delay=".1s">
              ...
              <h4 class="font-bold text-xl text-dark mb-3">Innovation</h4>
              <p class="text-body-color mb-8 lg:mb-11">
                Marketing is our passion, it enhances constantly our creativity
                which drives our innovative thoughts.
              </p>
              <a
          ...
          <div class="w-full md:w-1/2 lg:w-1/4 shrink-0 md:px-4">
            <div
            ...
            >
              ...
              <h4 class="font-bold text-xl text-dark mb-3">Integrity</h4>
              <p class="text-body-color mb-8 lg:mb-11">
                Integrity is the keystone that drives each of our footsteps, we
                honor our commitments with integrity.
              </p>
              <a
                href="javascript:void(0)"
                class="font-medium text-base text-body-color hover:text-primary"
          ...
          <div class="w-full md:w-1/2 lg:w-1/4 shrink-0 md:px-4">
            <div class="bg-white mb-12 group wow fadeInUp" data-wow-delay=".2s">
              ...
              <h4 class="font-bold text-xl text-dark mb-3">High-quality</h4>
              <p class="text-body-color mb-8 lg:mb-5">
                Our range of packaging machines are made in compliance with
                latest industry standards, using quality approved parts &
                components.
              </p>
              <a
                href="javascript:void(0)"
          ...
          <div class="w-full md:w-1/2 lg:w-1/4 shrink-0 md:px-4">
            ...
            >
              ...
              <h4 class="font-bold text-xl text-dark mb-3">Impact</h4>
              <p class="text-body-color mb-8 lg:mb-11">
                Our motivation is to make a positive difference by helping each
                of our clients to achieve their goals.
              </p>
              <a
                href="javascript:void(0)"
                class="font-medium text-base text-body-color hover:text-primary"
