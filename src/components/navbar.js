...
export default function Navbar({ isAdminPath }) {
  ...
  return (
    <div
      className={`ud-header ${
        isAdminPath ? "bg-primary" : "bg-transparent"
        ...
        <div className="flex -mx-4 items-center justify-between relative">
          <div className="flex px-4 justify-between items-center w-full">
            ...
            <div className="sm:flex justify-end hidden pr-16 lg:pr-0">
              <span className="text-base font-medium text-white bg-white bg-opacity-20 rounded-lg py-3 px-6 hover:bg-opacity-100 hover:text-dark signUpBtn duration-300 ease-in-out">
                {isAdminPath ? (
                  <>
                    <a href="/">Go to home</a>
                  </>
